...
public class WebsocketEchoHandler extends TextWebSocketHandler {
    ...
    */
	...
	public void afterConnectionEstablished(WebSocketSession wsession) throws Exception {
		// >>>> 파라미터 WebSocketSession wsession 은 웹소켓서버에 접속한 클라이언트 사용자이다.
	...
	//	System.out.println("====> 웹채팅확인용 : " + "연결 IP : " + wsession.getRemoteAddress().getAddress().getHostAddress()); 
		...
		*/
        ...
        // 확인용 connectingUserName : 「최병진 엄정화 이순신」;
	...
	//	System.out.println("~~~~ 확인용 messageVO.getTo() => " + messageVO.getTo());
        // ~~~~ 확인용 messageVO.getTo() => all 또는 1a, 1b 등
        ...
        for(WebSocketSession webSocketSession : connectedUsers) {
        	...
        	if("all".equals(messageVO.getType())) {
        		...
        		if( !wsession.getId().equals(webSocketSession.getId()) ) { // wsession.getId()는 자기자신
