...
public class BoardController {
	...
	private InterBoardService service; // 의존객체인 service
	
	// private InterBoardService service = new BoardService(); // bean 으로 이미 올라가있어서 쓸 필요 없다.
	...
	public String test_insert(HttpServletRequest request) {
		...
		request.setAttribute("message", message); //view에 보내기 위해 request라는 저장소에 넣어준다.
